...
from .models import DutySchedule, ClinicalCase, DutySwapRequest, MedicalUpdate, User, Subject, Topic, ExamSchedule, Result, DoctorSchedule, Book, Issue, ExamNotice, Payment, Salary, StudentRecord, WardSwapRequest, ClassSchedule,  Attendance, Notification, OperationSchedule, WardPosting
